...
def train(train_loader, model, optimizer_fixed, optimizer_liif):
    ...
    for batch in tqdm(train_loader, leave=False, desc='train'):
        ...
        inp_fixed = (batch['inp_fixed'] - inp_sub) / inp_div
        pred_fixed = model.forward_fixed(inp_fixed)

        gt = (batch['gt'] - gt_sub) / gt_div
        loss = loss_fn(pred_fixed, gt)
    ...
    return train_loss_fixed.item(), train_loss_liif.item()
...
def main(config_, save_path):
    ...
    for epoch in range(epoch_start, epoch_max + 1):
        ...
        train_loss_fixed, train_loss_liif = train(train_loader, model, optimizer)
